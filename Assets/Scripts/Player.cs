...
public class Player : NetworkBehaviour
{
    ...
    private void Move()
    {
        ...
        ServerMovementRPC(movementDirection, movementSpeedBase, movementSpeedMultiplier);
    }

    [ServerRpc]
    private void ServerMovementRPC(Vector2 movementDirection, float movementSpeedBase, float movementSpeedMultiplier)
    {
